...
const TAB_KEYS: Record<TabId, string[]> = {
  ...
  contact: ["contact.title","contact.subtitle","contact.name","contact.phone","contact.email","contact.date","contact.course","contact.message","contact.submit","contact.success","contact.countryCode","contact.phoneNumber","contact.phonePlaceholder","contact.namePlaceholder","contact.emailPlaceholder","contact.datePlaceholder","contact.coursePlaceholder","contact.messagePlaceholder","contact.dateKapitan1","contact.dateHafen1","contact.dateKapitan2","contact.dateHafen2","contact.dateFlexibel","contact.courseKapitan","contact.courseHafen","contact.courseUnsure","contact.whatsappTitle","contact.whatsappDesc","contact.whatsappButton","contact.phoneTitle","contact.phoneDesc","contact.emailTitle","contact.emailDesc","contact.emailButton","contact.trustTitle","contact.trustDesc","contact.bogdanTitle","contact.bogdanDesc","contact.coursesOnSite","contact.bogdanOnSite"],
...
function isLongText(key: string): boolean {
  const longKeys = ["description","brief","detailed","text","para","intro","outro","body","bio","quote","note","a1","a2","a3","a4","a5","a6","a7","a8","a9","a10","bodyTemplate","statsDescription","day1Brief","day2Brief","day3Brief","day4Brief","day5Brief","day6Brief","day7Brief","day8Brief","day1Detailed","day2Detailed","day3Detailed","day4Detailed","day5Detailed","day6Detailed","day7Detailed","day8Detailed","trustDesc","bogdanDesc","emailDesc","phoneDesc","whatsappDesc","fearsDialogIntro","fearsDialogAfterText","kautionNote","costsIntro","summaryTotal","transparencyNote","transparencyLabel","desc","list","points","groups","includes","options","formats","questions","schedule","advantages"];
